...
<?php
session_start();
$_SESSION['current_page']='newContact';
      ...
      <div class="col-md-12">
        ...
        <div class="widget">
          <div class="widget-head">
            <div class="pull-left">Nouveau contact</div>
          ...
          <div class="widget-content">
            <div class="padd">
              <!-- Content goes here -->
                <form id="newContact" class="form-horizontal" role="form" method="post">
                  ...
                  <div class="tab-pane fade in active" id="coord">
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <textarea class="form-control" rows="5" placeholder="" style="resize: vertical" name="adresseCompl"></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <input type="text" class="form-control" placeholder="" id="ville" name="ville" onkeyup="autocompleteTown(event)">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <input type="text" class="form-control" placeholder="" id="codePostal" name="codePostal" disabled>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <input type="email" class="form-control" placeholder="" name="tel1">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <input type="email" class="form-control" placeholder="" name="tel2">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <textarea class="form-control" rows="5" placeholder="" style="resize: vertical" name="notes"></textarea>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane fade" id="elev">
                    <div class="form-group">
                      ...
                      <div class="col-lg-5">
                        ...
                        <div class="radio">
                          <label>
                            <input type="radio" name="eleveur" id="eleveur2" value="0" onchange="radioChange()" checked="">
                            Non
                          </label>
                        </div>
                      </div>
                    ...
                    <fieldset class="fieldsetEleveur" style="display: none;">
                      ...
                      <div class="form-group">
                        <label class="col-lg-2 control-label">Nouvel élevage ?</label>
                        <div class="col-lg-5">
                          <div class="radio">
                            <label>
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="existElevage" id="ancienElevage" value="0" onclick="existingFarm()">
                              Non
                            </label>
                          </div>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <input type="text" class="form-control" placeholder="" name="nomElevage" id="nomElevage" onkeyup="triggerAutoCompleteFarm(event)">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-5">
                          <input class="form-control" placeholder="exemple : 3365982645" type="number" name="idElevage" id="idElevage" maxlength="10">
                        </div>
                      </div>
          ...
          <div class="widget-foot">
            <!-- Footer goes here -->
            <div class="form-group">
                <button type="button" id="contactValid" class="btn btn-sm btn-success" onclick="insertContactDB()">Valider</button>
