...
<head>
  ...
  <script type="text/javascript" src="js/script_mouvement.js"></script>
    ...
    <div class="widget">
      ...
      <div class="widget-content">
        <div class="padd">
          ...
          <form class="form-horizontal" id="mouvement" role="form" action="insert_db_mouvement.php" method="GET" name="mouvement">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="origineFarm">Lieu de provenance</label>
              <div class="col-lg-5">
                <input class="form-control" placeholder="Lieu de provenance" type="text" name="origineFarm" id="origineFarm" disabled>
              </div>
            </div>

            <div class="form-group">
              <label class="col-lg-2 control-label" for="destinationFarm">Lieu de destination</label>
              <div class="col-lg-5">
                <input class="form-control" placeholder="Lieu de destination" type="text" name="destinationFarm" id="destinationFarm" onkeyup="autoCompleteDestinationFarm(event)" required>
              </div>
            </div>

            <div class="form-group">
              <label class="col-lg-2 control-label" for="transferDate">Date du transfert</label>
              <div id="datetimepicker1" class="input-append input-group dtpicker datetimepicker1" style="padding-left: 15px;">
                <input id="transferDate" name="transferDate" data-format="yyyy-MM-dd" placeholder="AAA-MM-JJ" class="form-control" type="text">
