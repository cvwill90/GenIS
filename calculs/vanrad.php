    ...
    <div class="widget">
      ...
      <div class="widget-content">
        <div class="padd">
          ...
          $_SESSION['prog'] = 'vanrad';
          $prog = $_SESSION['prog'];
          $race = $_SESSION['race'];

          $result_ped_util = $_POST["entreeVanR"]; //rÃ©cupÃ©ration du rÃ©sultat de ped_util
          $f_sortie_vanrad = $_POST["sortieVanR"]; // fichier de sortie du programme vanrad
          ...
          echo '<form id="hiddenForm" name="hiddenForm" method="POST" action="postCalculs.php" role="form">
            ...
            <input type = "hidden" value = "'. $f_sortie_vanrad .'" id="sortie">
            </form>';
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Vanrad.exe est en cours d'exécution...</h4>
      </div>
